import 'package:ecommerce/src/widgets/extentions.dart';
  ...
  Widget _icon(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color:
            isOutLine ? Colors.transparent : Theme.of(context).dialogBackgroundColor,
        boxShadow: <BoxShadow>[
          const BoxShadow(
  ...
  Widget _sizeWidget(String text, {bool isSelected = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: const BorderRadius.all(Radius.circular(13)),
        color:
            isSelected ? LightColor.orange : Theme.of(context).dialogBackgroundColor,
      ),
      child: TitleText(
        text: text,
        fontSize: 16,
